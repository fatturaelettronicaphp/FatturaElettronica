...
class Xsd extends BasicDigitalDocumentValidator implements DigitalDocumentValidatorInterface
{
    public function validate(): Xsd
    {
    ...
    protected function getSchema(): string
    {
        ...
        return dirname(__DIR__) . '/xsd/' . $schemaFile;
    }
